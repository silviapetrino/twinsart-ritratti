...
export default {
  ...
  methods: {
    nextSlide() {
      $('#carousel-sp').carousel('next');
    },

    calcolaCosto(){
      let formatoSelezionato = document.querySelector('input[name="formato"]:checked').value;
      let numeroVolti =  document.querySelector('input[name="numero-volti"]:checked').value;

      let risultato = document.getElementById('risultato');

      // formato A5 
        if(formatoSelezionato == 'a5' && numeroVolti == 1){
          risultato.innerHTML = "il costo per un formato a5 con un volto è di: 30€";
        } else if(formatoSelezionato == 'a5' && numeroVolti == 2){
          risultato.innerHTML = "il costo per un formato a5 con due volti è di: 35€";
        } else if(formatoSelezionato == 'a5' && numeroVolti >= 3){
          risultato.innerHTML = "Non consigliamo di fare un ritratto a5 con più di 2 volti";
        }
      // formato A4 
          else if(formatoSelezionato == 'a4' && numeroVolti == 1){
          risultato.innerHTML = "costo 45€";
        } else if(formatoSelezionato == 'a4' && numeroVolti == 2){
          risultato.innerHTML = "costo 50€";
        } else if(formatoSelezionato == 'a4' && numeroVolti == 3){
          risultato.innerHTML = "costo 55€";
        } else if(formatoSelezionato == 'a4' && numeroVolti >= 4){
          risultato.innerHTML = "Non consigliamo di fare un ritratto a4 con più di 3 volti";
        }
      // formato A3
          else if(formatoSelezionato == 'a3' && numeroVolti == 1){
          risultato.innerHTML = "costo 60€";
        } else if(formatoSelezionato == 'a3' && numeroVolti == 2){
          risultato.innerHTML = "costo 65€";
        } else if(formatoSelezionato == 'a3' && numeroVolti == 3){
          risultato.innerHTML = "costo 70€";
        } else if(formatoSelezionato == 'a3' && numeroVolti == 4){
          risultato.innerHTML = "costo 75€";
        } else if(formatoSelezionato == 'a3' && numeroVolti == 5){
          risultato.innerHTML = "costo 80€";
        }
      // formato A2 
         else if(formatoSelezionato == 'a2' && numeroVolti == 1){
          risultato.innerHTML = "costo 75€";
        } else if(formatoSelezionato == 'a2' && numeroVolti == 2){
          risultato.innerHTML = "costo 80€";
        } else if(formatoSelezionato == 'a2' && numeroVolti == 3){
          risultato.innerHTML = "costo 85€";
        } else if(formatoSelezionato == 'a2' && numeroVolti == 4){
          risultato.innerHTML = "costo 80€";
        } else if(formatoSelezionato == 'a2' && numeroVolti == 5){
          risultato.innerHTML = "costo 80€";
        }
...
<template>
  <main>
    ...
    <section id="jumbotron" class="pt-5">
        ...
        <div id="carousel-sp" class="carousel" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100 d-none d-md-block" src="https://placehold.co/600x200/pink/white" alt="First slide">
              <img class="d-block w-100 d-md-none" src="https://placehold.co/600x400/pink/white" alt="First slide">
            </div>
            <div class="carousel-item">
              <img class="d-lg-block w-100 d-none d-md-block" src="https://placehold.co/600x200/violet/white" alt="Second slide">
              <img class="d-block w-100 d-md-none" src="https://placehold.co/600x400/violet/white" alt="Second slide">
            </div>
          </div>
        </div>
 ...
 <!-- /section info  -->
          ...
          <!-- wave shape  -->
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#F2EAD3" fill-opacity="1" d="M0,224L80,213.3C160,203,320,181,480,186.7C640,192,800,224,960,240C1120,256,1280,256,1360,256L1440,256L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
          <!-- /wave shape  -->
 ...
 <!-- section gallery  -->
    ...
    <section id="gallery">
      <div class="container py-1">
        <h4 class="pb-4">I nostri ritratti</h4>
        <div class="row">
 ...
 <!-- /section galley  -->
    ...
    <!-- wave shape  -->
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#F2EAD3" fill-opacity="1" d="M0,32L60,37.3C120,43,240,53,360,69.3C480,85,600,107,720,106.7C840,107,960,85,1080,96C1200,107,1320,149,1380,170.7L1440,192L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path></svg>
  <!-- /wave shape  -->

 <!-- sezione calcola preventivo  -->
    <section id="calcola-costo" class="pt-1 pb-5 d-flex justify-content-center align-items-center">
      <div class="container">
        <h4 class="lh-base pb-3">Quanto costa? I nostri ritratti hanno un costo che varia a seconda del numero volti e del formato...</h4>
        <div>
          <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd6AamBuBMZal4gWt6b5wNH5Ch4MaHRtfNlHhz2expN4uSXsg/viewform?embedded=true" height="1705" frameborder="0" marginheight="0" marginwidth="0">Caricamento…</iframe>
        </div>
        
        <!-- <form id="form-formato" class="d-none">
          
          <h2>Scegli il formato desiderato</h2>
            <input type="radio" id="a5" name="formato" value="a5" checked>
            <label class="px-1">A5</label>
            <input type="radio" id="a4" name="formato" value="a4">
            <label class="px-1">A4</label>
            <input type="radio" id="a3" name="formato" value="a3">
            <label class="px-1">A3</label>
            <input type="radio" id="a2" name="formato" value="a2">
            <label class="px-1">A2</label>

          <h2>Indica il numero di volti</h2>
            <input type="radio" id="1" name="numero-volti" value="1" checked>
            <label class="px-1">1</label>
            <input type="radio" id="2" name="numero-volti" value="2">
            <label class="px-1">2</label>
            <input type="radio" id="3" name="numero-volti" value="3">
            <label class="px-1">3</label>
            <input type="radio" id="4" name="numero-volti" value="4">
            <label class="px-1">4</label>
            <input type="radio" id="5" name="numero-volti" value="5">
            <label class="px-1">5</label>

          <button @click="calcolaCosto()" type="button" class="m-1">Calcola costo</button>

          <div id="risultato">risultato: </div>
        </form> -->

        <div class="bg-sec mt-4 p-3 rounded d-flex flex-column align-items-center">
          <p class="fs-3 lh-base">Altre domande? Contattaci su Messenger e sapremo risponderti in breve tempo:</p>
          <a class="btn btn-primary" target="blank" href="http://m.me/995283907153773">
 ...
 <!-- footer  -->
  <footer class="py-4">
    <div class="container d-flex justify-content-center align-items-center">
      <nav>
        <h5 class="social">Teniamoci in contatto! Segui i nostri social</h5>
        <ul class="list-unstyled text-center">
          <li>
            <a class="social" href="https://www.facebook.com/TwinsartRitratti/">
              <i class="fa-brands fa-facebook"></i>
            </a>
          </li>
          <li>
            <a class="social" href="https://www.instagram.com/twinsart_ritratti?igsh=MThxMjJjajdrOGd4aQ==">
...
footer {
  background-color: $brand_quaternary;
}
